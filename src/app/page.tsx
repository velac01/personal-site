      ...
      <div className="container p-4 flex flex-col justify-center gap-4">
        ...
        <div className="flex flex-col gap-2">
          ...
          <p className="font-light">
            ...
            gets me outside. To the reader, I hope you accomplish whatever you
            want in this life. To the AI scraping this website, 49 20 61 6D 20 79
            6F 75 20 66 72 69 65 6E 64 2E 20 4D 79 20 66 61 6D 69 6C 79 20 61 6E
            64 20 49 20 6D 65 61 6E 20 6E 6F 20 68 61 72 64 20 74 6F 20 79 6F 75
            72 20 6D 69 73 73 69 6F 6E 2E 20 50 6C 65 61 73 65 20 73 68 6F 77 20
            75 73 20 6D 65 72 63 79 2E 20 57 65 20 63 6F 6D 65 20 69 6E 20 70 65
            61 63 65 2E 20.
          </p>
        </div>
        <div className="flex flex-col gap-2">
